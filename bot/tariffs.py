...
_SERVICES: Dict[str, TariffService] = {
    ...
    "obhod": TariffService(
        ...
        description=(
            "Альтернативный канал. Позволяет обходить блокировки в таких городах, как "
            "Ижевск, Киров и среднее Поволжье. ⚠️ Мобильный интернет работает не на всех операторах."
        ),
